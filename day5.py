...
def gravityAssist2(instructions, input):
    ...
    while index < len(instructions) and instructions[index] != 99:
        ...
        if (len(opcode_string) == 1):
            ...
            opcode = opcode_string[-2:]
        param1_mode = 0
        param2_mode = 0
        param3_mode = 0
        if (len(opcode_string) > 2):
            param1_mode = int(opcode_string[-3:-2])
        if (len(opcode_string) > 3):
            param2_mode = int(opcode_string[-4:-3])
        if (len(opcode_string) > 4):
            param3_mode = int(opcode_string[-5:-4])
        index += 1
        index1 = instructions[index] if param1_mode == 0 else index
        index += 1
...
assert(gravityAssist2([3,1], 30) == 30) 
assert(gravityAssist2([4,1], 30) == 1) 
...
def gravityAssist3(instructions, input):
    index = 0
    while index < len(instructions) and instructions[index] != 99:
        opcode_string = str(instructions[index])
        prepend_last = False
        ...
        param3_mode = 0
        if (len(opcode_string) > 2):
            if (opcode_string[-3:-2] != "-"):        
                param1_mode = int(opcode_string[-3:-2])
                if (prepend_last and opcode_string[-4:-3] == '-'):
                    param1_mode = int(opcode_string[-4:-2])
        if (len(opcode_string) > 3):
            if (opcode_string[-4:-3] != "-"):        
                param2_mode = int(opcode_string[-4:-3])
                if (prepend_last and opcode_string[-5:-4] == '-'):
                    param2_mode = int(opcode_string[-5:-3])
        if (len(opcode_string) > 4):
            if (opcode_string[-5:-4] != "-"):
                param3_mode = int(opcode_string[-5:-4])
                if (prepend_last and opcode_string[-6:-5] == '-'):
                    param3_mode = int(opcode_string[-6:-4])
        index += 1
        index1 = instructions[index] if param1_mode == 0 else index
        index += 1
...
assert(gravityAssist3([3,9,8,9,10,9,4,9,99,-1,8], 8) == 1)
assert(gravityAssist3([3,9,7,9,10,9,4,9,99,-1,8], 8) == 0)
assert(gravityAssist3([3,3,1108,-1,8,3,4,3,99], 8) == 1)
assert(gravityAssist3([3,3,1107,-1,8,3,4,3,99], 8) == 0)
assert(gravityAssist3([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 0) == 0)
assert(gravityAssist3([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 1) == 1)
assert(gravityAssist3([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 10000) == 1)
assert(gravityAssist3([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], 0) == 0)
assert(gravityAssist3([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], 1) == 1)
assert(gravityAssist3([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], 10000) == 1)
...
assert(gravityAssist3(example, 0) == 999)
assert(gravityAssist3(example, 7) == 999)
