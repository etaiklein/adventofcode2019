...
def calculate(inputs):
    return sum([math.floor(inputItem / 3) - 2 for inputItem in inputs])

assert calculate([12]) == 2
assert calculate([14]) == 2
assert calculate([1969]) == 654
assert calculate([100756]) == 33583
assert calculate([1969, 100756]) == (654 + 33583)
...
def setUpRecursiveCalculation(inputs):
    return sum([recursivelyCalculate(calculate([inputItem])) for inputItem in inputs])

def recursivelyCalculate(inputItem):
    return inputItem + recursivelyCalculate(max(calculate([inputItem]), 0)) if inputItem != 0 else 0

assert setUpRecursiveCalculation([14]) == 2
assert setUpRecursiveCalculation([1969]) == 966
assert setUpRecursiveCalculation([100756]) == 50346
assert setUpRecursiveCalculation([1969, 100756]) == 966 + 50346
print setUpRecursiveCalculation(input)